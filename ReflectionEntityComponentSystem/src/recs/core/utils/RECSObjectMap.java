...
public class RECSObjectMap<K, V> {
	 ...
	 * backing table. */
	public RECSObjectMap () {
		this(32, 0.8f);
	}

	/** Creates a new map with a load factor of 0.8. This map will hold initialCapacity * 0.8 items before growing the backing
	 * table. */
	public RECSObjectMap (int initialCapacity) {
		this(initialCapacity, 0.8f);
	}

	/** Creates a new map with the specified initial capacity and load factor. This map will hold initialCapacity * loadFactor items
	 * before growing the backing table. */
	public RECSObjectMap (int initialCapacity, float loadFactor) {
	...
	public void putAll (RECSObjectMap<K, V> map) {
	...
	static private class MapIterator<K, V> {
		...
		final RECSObjectMap<K, V> map;
		int nextIndex, currentIndex;

		public MapIterator (RECSObjectMap<K, V> map) {
			this.map = map;
			reset();
		}
	...
	static public class Entries<K, V> extends MapIterator<K, V> implements Iterable<Entry<K, V>>, Iterator<Entry<K, V>> {
		...
		public Entries (RECSObjectMap<K, V> map) {
			super(map);
		}
	...
	static public class Values<V> extends MapIterator<Object, V> implements Iterable<V>, Iterator<V> {
		public Values (RECSObjectMap<?, V> map) {
			super((RECSObjectMap<Object, V>)map);
		}
		...
		public RECSArray<V> toArray () {
			RECSArray array = new RECSArray(true, map.size);
			while (hasNext)
				array.add(next());
			return array;
		}
		...
		public void toArray (RECSArray<V> array) {
			while (hasNext)
				array.add(next());
		}
	}
	...
	static public class Keys<K> extends MapIterator<K, Object> implements Iterable<K>, Iterator<K> {
		public Keys (RECSObjectMap<K, ?> map) {
			super((RECSObjectMap<K, Object>)map);
		}
